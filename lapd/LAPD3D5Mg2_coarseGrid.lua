...
-- local lines = io.lines("B_vs_z.txt") -- open file as lines
...
n0 = 2.0e18 -- initial number density
...
B0 =  0.05 --linearInterp(BzLAPD, zLAPD, 0.) / 1e4 -- convert to Tesla
...
momentApp = Moments.App {
   ...
   emSource = Moments.CollisionlessEmSource {
      ...
      staticEmFunction = function(t, xn)
         ...
         local Bz = 0.05 -- linearInterp(BzLAPD, zLAPD, z) / 1e4
